	...
	<section>
		<div class="jumbotron">
			<div class="container">
				...
				<h4 class="col-sm-2">
					<a href="?language=en_US">English</a>|<a href="?language=es_ES">Spanish</a>
				</h4>
			</div>
			...
			<div class="container">
				...
				<security:authorize access="isAuthenticated()">
					<a href="<spring:url value='/patient/viewAppointments' />"
						class="btn btn-default"><spring:message code='form.viewAppointments' /></a>
				</security:authorize>
				<a href="<spring:url value='/appointment/make' />"
					class="btn btn-default"> <span
					class="glyphicon-hand-left glyphicon"></span><spring:message code='makeAppointment'/>
				</a>
				<a href="javascript:openCustomerChat();" class="btn btn-default"><spring:message
						code='chat' /></a>
				<security:authorize access="isAnonymous()">
					<a href="<spring:url value='/login' />" class="btn btn-default"><spring:message
							code='login' /></a>
				</security:authorize>
				<security:authorize access="isAuthenticated()">

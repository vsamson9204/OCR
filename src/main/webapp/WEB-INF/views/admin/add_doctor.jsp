...
<section class="container">
	<h1>
		<spring:message code="form.addDoctor" />
	</h1>
	<script type="text/javascript"
		src="<spring:url value="/resource/js/ajax.js"/>"></script>
	<form:form modelAttribute="doctor" class="form-horizontal"
		...
		<div class="form-group form-group-sm">
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="doctorCategory"><spring:message
							code="form.doctorCategory" /></label>
					<div class="col-sm-8">
						<form:select class="form-control" id="doctorCategory"
							path="doctorCategory" items="${categories}" itemValue="id"
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<a href="javascript:addCategory();"><spring:message
								code="newCategory" /></a>
					</div>
					<div class="col-sm-5" id="categoryForm" style="display: none;">
						...
						<div class="col-sm-4">
							<input type="button" class="btn btn-default"
								onclick="saveCategory()" value="Save" />
						</div>
					</div>
				</div>
				<div class="form-group" id="result" style="display: none;">
					...
					<div class="col-sm-8">
						...
						<div id="success" class="text-info">
							<spring:message code='info.categorySaved' />
						</div>
					</div>
				</div>
				<p class="lead">
				...
				<div class="form-group">
					<label for="city" class="col-sm-4 control-label"><spring:message
							code="form.city" /></label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label for="zip" class="col-sm-4 control-label"><spring:message
							code="form.zip" /></label>
					<div class="col-sm-8">
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<form:textarea id="portfolio" path="portfolio"
							class="form-control" type="textarea" cols="20" rows="10" />
						<form:errors path="portfolio" cssClass="text-danger" />
					</div>
				</div>
				<div class="form-group">
					<label for="timespans" class="col-sm-4 control-label"><spring:message
							code="form.timespan" /></label>
					<div class="col-sm-8">
						<div id="timespanList">
							<c:forEach items="${timespans}" var="timespan">
								<div>
									<form:checkbox path="availableTimespans" value="${timespan.id}"
				...
				<div class="form-group">
					...
					<div class="col-sm-8"">
						<input type="submit" id="btnAdd" class="btn btn-primary"
							value="Save Doctor" class="form-control" />
					</div>
				</div>
			</div>
		</div>
